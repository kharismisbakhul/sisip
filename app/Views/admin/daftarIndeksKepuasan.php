                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="button-group">
                                                    <form action="<?= base_url('/AdminController/hapusIndeksKepuasan') ?>" method="post" class="d-inline">
                                                    ...
                                                    <a href="<?= base_url('/admin/editIndeksKepuasan/'.$in['id']) ?>" class="btn btn-info"><i class="fas fa-edit mr-2"></i>Edit</a>
                                                    <a href="<?= base_url('/AdminController/ubahStatusIndeks/'.$in['id']) ?>" class="btn btn-warning"><i class="fas fa-check-circle mr-2"></i>Ubah
                                                        Status</a>
                                                    <a href="<?= base_url('/admin/hasilIndeksKepuasan/'.$in['id']) ?>" class="btn btn-primary"><i class="fas fa-eye mr-2"></i>Hasil</a>
        ...
        <div class="modal fade" id="editUser" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1">
            <div class="modal-dialog " role="document">
                <div class="modal-content">
                    ...
                    <form action="<?= base_url('/admin/tambahIndeksKepuasan')?>" method="post">
