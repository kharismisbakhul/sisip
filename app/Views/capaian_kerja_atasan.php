                    ...
                    <div class="card earning-widget">
                        ...
                        <div class="card-body border-top">
                            <table class="table v-middle ">
                                <tbody>
                                    <tr>
                                        <td style="width:40px"><img src="../../assets/images/users/1.jpg" width="60"
                                                class="rounded-circle" alt="logo"></td>
                                        <td>
                                            <div class="comment-text w-100">
                                                <h5 class="d-block">Sarah Wijayanto</h5>
                                                <i class="fas fa-id-card mr-2"></i> <span>123132</span><br>
                                                <i class="fas fa-user-md mr-2"></i> <span>Kasirir</span>
                                            </div>
                                        </td>
                                        <td align="right">
                                            <div class="button-group">
                                                <button type="button"
                                                    class="btn btn-sm waves-effect waves-light btn-info">Detail</button>
                                                <button type="button"
                                                    class="btn btn-sm  waves-effect waves-light btn-success">Penilaian</button>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body ml-5">
                            <img src="../../assets/images/undraw_dashboard.svg" width="63%" class="mx-auto d-block"
                                alt="">
                        </div>
                        <div class="card-body ml-5">
